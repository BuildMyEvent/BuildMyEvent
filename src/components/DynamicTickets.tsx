...
export default function DynamicTickets({ tickets }: TicketsProps) {
    return (
        <section className="flex flex-col lg:flex-row justify-center items-center gap-10 py-12 relative">

            {tickets?.map((item, index) => {
                return (
                    <div key={index} className="bg-[#f8f8f9] border rounded-2xl p-8 max-w-md w-full relative z-10 lg:-mr-12 -mt-9 ">
