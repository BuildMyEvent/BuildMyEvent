...
export default function TerminalComponent({ children }: TerminalComponentProps) {
  return (
    <div className="flex flex-col border-[1px] border-gray-400 w-full rounded-xl">
      ...
      <div className=" bg-dark-blue border rounded-t-xl flex items-center top-0 left-0 px-4 justify-between h-8 bg-code-background w-full bg-default-100 dark:bg-default-50 border-b-[1px] border-gray-400">
